set DIR=M:\/GTK_install\/

set INCLUDES=-I. -I %DIR%\/GTK\/include\/gtk-2.0 -I %DIR%\/GTK\/include\/glib-2.0 -I %DIR%\/GTK\/lib\/glib-2.0\/include -I %DIR%\/GTK\/include\/cairo\/ -I %DIR%\/GTK\/include\/pango-1.0\/ -I %DIR%\/GTK\/lib\/gtk-2.0\/include -I %DIR%\/GTK\/include\/gdk-pixbuf-2.0 -I %DIR%\/GTK\/include\/atk-1.0
