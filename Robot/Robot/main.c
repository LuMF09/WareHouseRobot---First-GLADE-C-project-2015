...
/*================================================
 * Macro constantes on définit la table 
 *===============================================*/
...
int main (int argc, char *argv[]) {
  ...
  /* On récupère le tableau, puis on récupère les différents boutons/ dans notre cas on veut définir un espace, placer les différentes zones*/
...
;
  ...
  /* Initialisation du tableau comme terrain vide (obstacle et zone non disposé) */
